...
import wiki.scene.tab.IndicatorStyle;
 ...
 * @Function: {@link wiki.scene.tab.CommonTabLayout}及{@link wiki.scene.tab.SlidingTabLayout}共有属性及Java设置方法代理
 * @Description: 1、2018-12-4 13:41:55 将{@link wiki.scene.tab.CommonTabLayout}及{@link wiki.scene.tab.SlidingTabLayout}共有属性初始值进行调整
 */
