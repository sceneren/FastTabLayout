package wiki.scene.tab.delegate;
...
import wiki.scene.tab.R;
import wiki.scene.tab.TextBold;
import wiki.scene.tab.listener.ITabLayout;
...
public class TabLayoutDelegate<T extends TabLayoutDelegate> {
     ...
     * tab
     */
    protected int mTabSelectBg;
    protected int mTabDefaultBg;
    ...
    public TabLayoutDelegate(View view, AttributeSet attrs, ITabLayout iTabLayout) {
        ...
        mTabDefaultBg = mTypedArray.getResourceId(R.styleable.TabLayout_tl_tab_default_bg, 0);
        mTabSelectBg = mTypedArray.getResourceId(R.styleable.TabLayout_tl_tab_select_bg, 0);
    }
    ...
    public int getTabSelectBg() {
        return mTabSelectBg;
    }

    public void setTabSelectBg(int mTabSelectBg) {
        this.mTabSelectBg = mTabSelectBg;
    }

    public int getTabDefaultBg() {
        return mTabDefaultBg;
    }

    public void setTabDefaultBg(int mTabDefaultBg) {
        this.mTabDefaultBg = mTabDefaultBg;
    }
}
